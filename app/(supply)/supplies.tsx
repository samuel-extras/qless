...
const Supplies = () => {
    ...
    const handleFecth = async (page?: number) => {
        ...
        setLoader(true);
        const res: any = await new SupplyAPIManager().getsupplies(query);
    ...
    const handleDelete = async () => {
        ...
        setSupply(undefined);
        setLoader(true);
        const res: any = await new SupplyAPIManager().deleteSupply(id);
        setLoader(false);
        setServerRes({
            ...res,
        });
        ...
        <>
            ...
            >
                <DataTable style={styles.container}>
                    ...
                    {supplies.map((e, i) => (
                        <DataTable.Row key={i} onPress={() => setSupply(e)}>
            ...
            <TouchableOpacity
                style={styles.addBtn}
                onPress={() => router.push("/(supply)/add-supply")}
            >
                <FontAwesome
                    name={"plus"}
                    color={"#fff"}
